...
//Credits: Christian Watts, Lexical Analyzer
...
/********************************************************************/
	/*assign - parse strings in the language generated by the rule : <assign> -> id = <expr>*/
	static void assign(){	
		...
		//If the RHS is ( <expr>), call lex to pass over the left parenthesis, call expr, and check for the right parenthesis
			...
			if(nextToken == LEFT_PAREN){
				...
				if(nextToken == RIGHT_PAREN)
					...
					System.out.println("ERROR - Expression is incorrect, Grammar not appropriate");
				
			} //End of if (nextToken == ...
			// It was not an id, and integer literal, or a left parenthesis
			else
				System.out.println("ERROR - Expression is incorrect, Grammar not appropriate");
		} //End of else
